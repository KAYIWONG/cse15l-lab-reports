...
//pics show below ![image]labpic2.png
...
//pics show below  ![image]labpic5.png
...
javac (fileName).java 
java (fileName)
////pics show below  ![image]labpic6.png
